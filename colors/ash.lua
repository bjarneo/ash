...
local colors = {
	...
	-- UI colors
	bg_alt = palette.gray1,
	bg_highlight = palette.gray1,
	bg_visual = palette.gray2,
	border = palette.gray1,

	-- Syntax colors
	comment = palette.gray3,
	comment_alt = palette.gray3,

	-- Functions and methods
	func = palette.fg_bright,
	func_builtin = palette.fg_bright,

	-- Strings
	string = palette.gray5,
	string_template = palette.gray5,
	string_escape = palette.gray4,
	string_regex = palette.gray4,

	-- Keywords and control flow
	keyword = palette.gray4,

	-- Types and classes
	type = palette.gray4,

	-- Constants and numbers
	constant = palette.gray5,
	number = palette.gray5,
	boolean = palette.gray5,
	...
	operator = palette.gray4,
	punctuation = palette.gray3,

	-- Special colors
	cursor = palette.gray3,
	line_number = palette.gray3,
	line_number_active = palette.fg_bright,

	-- Diagnostic colors
	error = palette.gray4,
	warning = palette.gray4,
	info = palette.gray4,
	hint = palette.gray4,

	-- Git colors
	git_add = palette.gray2,
	git_change = palette.gray2,
	git_delete = palette.gray2,
	git_ignore = palette.gray3,

	-- Terminal colors
	terminal_black = palette.bg,
	terminal_red = palette.gray4,
	terminal_green = palette.gray2,
	terminal_yellow = palette.gray4,
	terminal_blue = palette.gray4,
	terminal_magenta = palette.gray4,
	terminal_cyan = palette.gray4,
	terminal_white = palette.fg,
	terminal_bright_black = palette.gray1,
	terminal_bright_red = palette.gray4,
	terminal_bright_green = palette.gray2,
	terminal_bright_yellow = palette.gray4,
	terminal_bright_blue = palette.gray4,
	terminal_bright_magenta = palette.gray4,
	terminal_bright_cyan = palette.gray4,
	terminal_bright_white = palette.fg_bright,
